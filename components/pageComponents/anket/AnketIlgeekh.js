          ...
          uilchilgee(token)
            .post(`/msgIlgeeye`, {
              ...
              msgnuud: [
                {
                  to: utasniiDugaar,
                  text: `Ta daraakh kholboosoor orj anket bogolnuu: https://gnettest.zevtabs.mn/khyanalt/anket/${baiguullaga?._id}/${data._id}`,
                },
              ],
            })
            .then(({ data }) => {
              ...
              mailuud: [
                {
                  mail: email,
                  subject: "Анкет",
                  content: `Та <a style="text-decoration: underline; font-size:20px" href="https://gnettest.zevtabs.mn/khyanalt/anket/${baiguullaga?._id}/${data._id}">энд</a> дарж анкет илгээнэ үү.`,
                },
              ],
            })
            .then(({ data }) => {
